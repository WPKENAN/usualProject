...
CACHE_DIR = INPUT_DATA+"\\..\\cache"
MODEL_2015TRAIN=INPUT_DATA+"\\..\\checkpoint_dir\\MyModel"
# 验证的数据的百分比
...
def get_or_create_bottleneck(sess, image_lists, label_name, index, category, jpeg_data_tensor, bottleneck_tensor):
    ...
    # outfile1=open("log1.txt",'w');
    # outfile1.write(bottleneck_path)
...
def main():
    ...
    with tf.name_scope('evaluation'):
        ...
        tf.summary.scalar("evaluation_step", evaluation_step)
    ...
    with tf.Session() as sess:
        ...
        for i in range(STEPS):
            ...
            # print(len(train_ground_truth))
            summary,train_accuracy = sess.run([merged,evaluation_step], feed_dict={
