...
from snake_utils import imrotate, plot_snakes, CNN_B, snake_graph, plot_for_figure,CNN_RES
...
# numfilt = [256,256,256,256,256,256]
im_size = 512
out_size = 256
data_path = './data/'
...
with tf.device('/gpu:0'):
    ...
    grad_predA, grad_predB, grad_predK, grad_l2loss, x, y_ = CNN_RES(im_size, out_size, L, batch_size=1,wd=0.01,layers=len(numfilt),numfilt=numfilt)
