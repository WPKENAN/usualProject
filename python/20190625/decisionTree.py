...
def train(path,header):
    ...
    plt.legend()
    plt.title("DecisionTreeRegressor max_depth={} (R-squared:{:.2f} MSE:{:.2f} MAE:{:.2f})".
              format(max_depth, my_model.score(X_test, y_test),
