...
%% Define the size of final realizations
 p = 150; % Size of the final realizations in I,X dimension
 q = 100; % Size of the final realizations in J,Y dimension
 r = 50; % Size of the final realizations in K,Z dimension
